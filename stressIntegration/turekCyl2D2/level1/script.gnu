...
set ylabel "Cd"
set output 'drag.pdf'
plot "tRhoCdCl.dat" u 2:4 title "Momentum-Exchange" w l ls 1,\
     "tRhoCdCl.dat" u 2:6 title "Stress Integration" w l ls 2,\
     Ref_Drag title "Benchmark Drag" ls 3 dashtype "-"

# Ref_Lift=10.53
set ylabel "Cl"
set output 'lift.pdf'
plot "tRhoCdCl.dat" u 2:5 title "Momentum-Exchange" w l ls 1,\
     "tRhoCdCl.dat" u 2:7 title "Stress Integration" w l ls 2,\
