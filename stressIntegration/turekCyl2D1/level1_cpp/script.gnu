...
set ylabel "Cd"
set output 'drag.pdf'
plot "tRhoCdCl_P400_H82.dat" every ::0000::10000 u 2:4 title "Momentum-Exchange" w l ls 1,\
     "tRhoCdCl_P400_H82.dat" every ::0000::10000 u 2:6 title "Stress Integration" w l ls 2,\
      Ref_Drag title "Benchmark Drag" ls 3 dashtype "-"

# Ref_Lift=10.53
set ylabel "Cl"
set output 'lift.pdf'
plot "tRhoCdCl_P400_H82.dat" every ::0000::10000 u 2:5 title "Present Lift" w l ls 1,\
     "tRhoCdCl_P400_H82.dat" every ::0000::10000 u 2:7 title "Present Lift" w l ls 2,\
 Ref_Lift title "Benchmark Lift" ls 3 dashtype "-"