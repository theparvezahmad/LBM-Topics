...
set output 'drag.png'
plot "tRhofxfy.dat" every ::10000::20000 u 1:3 title "Present Drag" w l ls 1#, Ref_Drag title "Benchmark Drag" ls 2 dashtype "-"

Ref_Lift=10.53
set ylabel "Lift Force"
set output 'lift.png'
plot "tRhofxfy.dat" every ::10000::20000 u 1:4 title "Present Lift" w l ls 1#, Ref_Lift title "Benchmark Lift" ls 2 dashtype "-"
